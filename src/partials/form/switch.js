...
export default class Switch extends React.Component {
  static calculateDimensions(size) {
    switch (size) {
      ...
      case 'large':
        return ({
          width: verticalScale(55), padding: 0, circleWidth: verticalScale(28),
          circleHeight: verticalScale(28), translateX: verticalScale(30),
        });
      case 'X-large':
        return({
          width: 65, circleWidth: 35, circleHeight: 35, translateX: 38,
        });
      case 'X-large-border':
        return ({
          width: 64, circleWidth: 35, circleHeight: 35, translateX: 38,
        });
      default:
        return ({
